...
class UserController extends Controller
{
    ...
    { 
        ...
        if ($request->hasFile('foto')) {
            ...
            $foto->storeAs('public/uploads', $fotoName); // Simpan foto di storage/app/public/uploads
        } else {
            $fotoName = null;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('foto')) {
            ...
            if ($oldFilename) {
                Storage::delete('public/uploads/' . $oldFilename); // Hapus foto lama
            }

            // Simpan file baru dengan storeAs
            $file = $request->file('foto');
            $newFilename = time() . '_' . $file->getClientOriginalName();
            $file->storeAs('public/uploads', $newFilename); // Simpan file di storage/app/public/uploads
    ...
    public function destroy($id)
    {
        ...
        if ($user->foto) {
            Storage::delete('public/uploads/' . $user->foto); // Hapus foto dari storage
        }
